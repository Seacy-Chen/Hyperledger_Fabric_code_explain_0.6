...
// ChainCodeSupportServer会根据Client调用注册函数创建该Stream的Handler处理句柄，
...
// 对于Server而言，我们刚刚创建了handler又有ProcessStream消息响应循环，
// 这样RegisterMessage就交到了ProcessStream手里，ProcessStream根据消息类型执行命令分发
